...
Cross Correlation Matrix for the past 2 Years tells us how each individual asset moves relative to one another. Only correlations to bitcoin are currently used for portfolio assembly.
